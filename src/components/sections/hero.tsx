...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-white to-violet-50">
      {/* Background Elements */}
          ...
          <div className="relative w-full max-w-4xl mx-auto aspect-[16/9] glass-effect rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <p className="text-gray-500 text-lg mb-4">Post Preview Coming Soon</p>
